...
# ax1 = fig.add_subplot()
# ax1.scatter(esprit_locations[0], arr_of_ones, marker='o', color='red', s=60, label='-20 dB')
# ax1.scatter(esprit_locations[1], arr_of_ones, marker='o', color='blue', s=60, label='-10 dB')
# ax1.scatter(esprit_locations[2], arr_of_ones, marker='o', color='green', s=60, label='0 dB')
# ax1.scatter(esprit_locations[3], arr_of_ones, marker='o', color='orange', s=60, label='10 dB')
...
# fig = plt.figure(figsize=(8, 8))
# ax2 = fig.add_subplot()
# ax2.scatter(esprit_locations[0], arr_of_ones, marker='o', color='red', s=60, label='N = 5 Elements')
# ax2.scatter(esprit_locations[1], arr_of_ones, marker='o', color='blue', s=60, label='N = 50 Elements')
# ax2.scatter(esprit_locations[2], arr_of_ones, marker='o', color='green', s=60, label='N = 100 Elements')
...
esprit_locations = []
power_noise = power_source / (10 ** (10 / 10))
ula = model.UniformLinearArray(50, d0)
...
# Root-MUSIC for varying array size [5, 20, 100] (SNR = 0dB)
esprit_locations = []
...
fig = plt.figure(figsize=(8, 8))
ax3 = fig.add_subplot()
ax3.scatter(esprit_locations[0], arr_of_ones, marker='o', color='red', s=60, label='N = 5 Elements')
ax3.scatter(esprit_locations[1], arr_of_ones, marker='o', color='blue', s=60, label='N = 20 Elements')
ax3.scatter(esprit_locations[2], arr_of_ones, marker='o', color='green', s=60, label='N = 100 Elements')
